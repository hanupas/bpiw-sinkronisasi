...
<html lang="en">
  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        <h1>PROGRAM RENCANA STRATEGIS</h1>
      ...
      <table border='1'>
          <tr>
              ...
              <th>Program_Id</th>
              <th>Program_Nama</th>
              <th>Program_UnitOrg</th>
              <th>Edit</th>
              <th>Delete</th>
          </tr>
          <?php foreach($md as $row){ ?>
          <tr>
              <td><?php echo $row->rpjmid ?></td>
              <td><?php echo $row->program_id ?></td>
              <td><?php echo $row->program_nama ?></td>
      ...
      <div class="well well-sm">Memasukkan Program 5 tahunan</div>
      <div class="row feature">
                                <div >
                                    <!--<img width="100%" src="<?php echo base_url('asset/images/RENSTRA.jpg'); ?>">-->
                                </div>
                          </div>
