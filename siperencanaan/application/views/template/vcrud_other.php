...
<div id="info"></div>
	...
	$.ajax({
	   type: "POST",
	   url: "<?php echo base_url('index.php/Welcome/newData') ?>",
	   data: datas
	}).done(function( data ) {
	  $('#info').html(data);
	  viewdata();
	...
	$.ajax({
	   type: "POST",
	   url: "<?php echo base_url('index.php/Welcome/updateData') ?>"+"/"+id,
	   data: datas
	}).done(function( data ) {
	  $('#info').html(data);
	  viewdata();
	...
	$.ajax({
	   type: "GET",
	   url: "<?php echo base_url('index.php/Welcome/deleteData') ?>"+"/"+id,
	}).done(function( data ) {
	  $('#info').html(data);
	  viewdata();
	});
