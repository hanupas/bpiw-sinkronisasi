...
-->	  
	<div class="panel panel-default">
            <div class="panel-heading">Penyusunan SE Pagu ANGGARAN DEFINITF</div>
	...
	<div class="row">
            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                     ...
                     <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="tab" data-parent="#accordion" href="#tab7default">View Fstok Definitif</a>
                        </h4>
                    </div>
                </div>
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                <h1>PENYUSUNAN SE PAGU ANGGARAN DEFINITIF</h1>
            ...
            <div class="tab-content">
                        <div class="tab-pane fade" id="tab1default"><div class="well well-sm">
                            <ol >
                                <li>Sistem meminta untuk memasukkan nilai pagu alokasi anggaran  APBN </li>
                                <li>Sistem akan mengurutkan RKA K/L sementara  berdasarkan perhitungan prioritas hasil assesment BPIW </li>
                                <li>Sistem akan menampilkan usulan kegiatan yang diterima untuk diproses lebih lanjut, berdasarkan alokasi anggaran yang ditetapkan</li>
                        ...
                        <div class="tab-pane fade" id="tab4default"><div class="well well-sm">Sistem mempersilahkan pengguna untuk menetapkan sebuah versi simulasi menjadi legal sebagai SEB Pagu Anggaran ( RKA-K/L Definitif )</div></div>
                        ...
                        <div class="tab-pane fade" id="tab7default"><div class="well well-sm">Berisi usulan kegiatan di tahap pagu Indikatif yang ditolak ditambah usulan kegiatan yang ditolak juga untuk masuk ke RKA K/L  Definitif</div></div>
                    </div>
        </div>
    </div>
