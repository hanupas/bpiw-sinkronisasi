 ...
 $(document).ready(function() {
        ...
        function validate_dept(){
            ...
            columns    : [[
                ...
                {field:'nmdept',title:'Nama ',width:380}
            ]],
         ...
         function validate_unit(){
            ...
            columns    : [[
                ...
                {field:'nmunit',title:'Nama ',width:380}
            ]],
            onSelect:function(rowIndex,rowData){
...
<!--		<div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> -->
			...
			<div class="row">                
				<div class="iconmelon">
                                  <image src="<?php echo base_url('asset/images/LogoPU.jpg'); ?>" width="200px" />
				</div>
			</div>
                        <br /><br />
...
<table 
    cellspacing="2px" bgcolor="#F4F5F7" width="650px" height="200px" align="center" class="tableBorder">
             <tr>
                    <td colspan="5" bgcolor="#060166">&nbsp;</td>
                 ...
                 <tr>
                    ...
                    <td align="center" colspan="5">
                        ...
                        <span class="message" style="color:#060166">SISTEM INFORMASI <BR> PERENCANAAN PEMROGRAMAN TERSINKRONISASI</span>        </td>
                </tr>
                <tr>
                 <td></td>
                <td></td>
...
<td><?php echo form_input('Username')?></td>
 ...
 -->
    ...
    <tr>
        <br>
        <br>
                <td width="30%"><b><span style="color:#060166">PERUSAHAAN/LEMBAGA</span></b></td>
                <td width="1%">:</td>
                <td><input type="ket" id="sskpd" name="sskpd" style="width:65px;"/>
                <input id="nmskpd" name="nmskpd" style="width:270px;"  /></td>

    </tr>
    <tr>
                <td width="30%"><b><span style="color:#060166">UNIT</span></b></td>
                <td width="1%">:</td>
                <td><input type="unit" id="sskpdun" name="sskpdun" style="width:65px;"/>
...
<tr></tr>
    <tr>
                <td width="30%"><b><span style="color:#060166">USERNAME</span></b></td>
                <td width="1%">:</td>
                <td><input type="text"  name="username" style="width:120px;"/>
            

    </tr>
<tr>
                <td width="30%"><b><span style="color:#060166" >PASSWORD</span></b></td>
                <td width="1%">:</td>
...
<?php echo form_password('password')?>
 ...
 -->
<tr>
<td class="label" align="right" style="color:#060166" ><b>Tahun Anggaran</b></td>
    <td>
    :</td>
    <td>
