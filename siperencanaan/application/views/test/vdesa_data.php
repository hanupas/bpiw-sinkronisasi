...
<form>
  <div class="form-group">
    <label for="nm">Kecamatan111</label>
    <input type="text" class="form-control" id="u1">
  </div>
  <div class="form-group">
    <label for="nm">Kecamatan</label>
    <input type="text" class="form-control" id="u2" value="<?php echo $row->kecamatanID; ?>">
  </div>
  <div class="form-group">
    <label for="gd">Nama Lokasi</label>
    <input type="text" class="form-control" id="u3" value="<?php echo $row->namaLokasi; ?>">
  </div>
</form>
