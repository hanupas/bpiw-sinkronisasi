...
<html lang="en">
  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        <h1>Assessement BPIW</h1>
        <p>Sistem Informasi Perencanaan Tersinkronisasi Pembangunan Infrastruktur PUPR(SIP)</p>
      </div>
      <div class="well well-sm">BPIW memverifikasi hasil self assesment pengusul kegiatan </div>
      <div class="row feature">
            <div >
                <!--<img width="100%" src="<?php echo base_url('asset/images/AssesmentBPIW.jpg'); ?>">-->
            </div>
      </div>
		
      <div class="row feature">
            <div >
                <!--<img width="100%" src="<?php echo base_url('asset/images/AssesmentKegiatan.jpg'); ?>">-->
            </div>
      </div>
