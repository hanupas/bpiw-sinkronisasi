...
<html lang="en">
  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        <h1>Self Assessement BPIW</h1>
        <p>Sistem Informasi Perencanaan Tersinkronisasi Pembangunan Infrastruktur PUPR(SIP)</p>
      </div>
	<div class="well well-sm">Menampilkan usulan kegiatan yang gap antara nilai Self Assesment dan Assesment BPW lebar, untuk keperluan klarifikasi dengan pengusul atau assesment ulang</div>	
      <div class="row feature">
            <div >
                <!--<img width="100%" src="<?php echo base_url('asset/images/Entry-Kegiatan-SelfAsssesment.jpg'); ?>">-->
            </div>
