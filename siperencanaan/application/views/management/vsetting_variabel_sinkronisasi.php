...
-->	  
	 <div class="panel panel-default">
            <div class="panel-heading">Setting Variabel Sinkronisasi</div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="tab" data-parent="#accordion" href="#tab1default">Variabel</a>
                        </h4>
                    </div>
...
<!--                    <div id="collapseOne" class="panel-collapse collapse">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="tab" data-parent="#accordion" href="#tab2default">Setting Bobot Variabel</a>
                        </h4>
                    </div>
			
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="tab" data-parent="#accordion" href="#tab3default">Setting Indikator dan Parameter</a>
                        </h4>
                    </div>
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                <h1>Manajemen Data Kalender Setting Variabel Sinkronisasi</h1>
                Sistem Informasi Perencanaan Tersinkronisasi Pembangunan Infrastruktur PUPR(SIP)
            </div>
            <div class="panel-body">
                    <div class="tab-content">
                        <div class="tab-pane fade" id="tab1default"><div class="well well-sm">CRUD Varibel Keputusan</div>
                            <div class="row feature">
                                <div >
                                    <!--<img width="100%" src="<?php echo base_url('asset/images/SetVarSinkronisasi-Variabel.jpg'); ?>">-->
                                </div>
                          </div>
                        </div>
                        <div class="tab-pane fade" id="tab2default"><div class="well well-sm">Menset Variabel yang diaktifkan/non aktif untuk sebuah tahun</div>
                            <div >
                                    <!--<img width="100%" src="<?php echo base_url('asset/images/SetVarSinkronisasi-BobotVariabel.jpg'); ?>">-->
                                </div>
                        </div>
                        <div class="tab-pane fade" id="tab3default"><div class="well well-sm">CRUD Indikator , parameter, nilai dari setiap wariabel</div>
                            <div class="row feature">
                                <div >
                                    <img width="100%" src="<?php echo base_url('asset/images/SetVarSinkronisasi-IndikatorParameter.jpg'); ?>">
                                </div>
                          </div>
                        </div>
                    </div>
