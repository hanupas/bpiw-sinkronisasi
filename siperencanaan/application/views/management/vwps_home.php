	...
	<div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Cmanagement/MasterWPS') ?>">Master WPS</a>
                        </h4>
                    </div>
                    
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Cmanagement/MasterWPS') ?>">Master Tema</a>
                        </h4>
                    </div>
		
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Cmanagement/MasterWPS') ?>">Sub WPS</a>
                        </h4>
                    </div>
                </div>
        ...
        <div class="col-sm-9 col-md-9">
            ...
            <div class="panel-body">
             ...
             <div> <img width="100%" src="<?php echo base_url('asset/images/SubTema.png'); ?>"></div>   
        </div>
