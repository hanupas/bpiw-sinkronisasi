...
-->	  
	<div class="panel panel-default">
            <div class="panel-heading">WPS</div>
	...
	<div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Cmanagement/ProgramStrategis') ?>">Create Fungsi</a>
                        </h4>
                    </div>
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Cmanagement/ProgramStrategis') ?>">Create Benefit</a>
                        </h4>
                    </div>
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Cmanagement/ProgramStrategis') ?>">Create Indikator Benefit</a>
                        </h4>
                    </div>
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Cmanagement/ProgramStrategis') ?>">Program Strategis WPS</a>
                        </h4>
                    </div>
        ...
        <div class="col-sm-9 col-md-9">
            ...
            <div class="panel-body">
             ...
             <div> <img width="100%" src="<?php echo base_url('asset/images/Create_Fungsi.png'); ?>"></div>   
        </div>
