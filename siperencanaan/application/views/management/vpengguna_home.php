...
-->	  
	...
	<div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Cmanagement/Departement') ?>">Master Departemen</a>
                        </h4>
                    </div>
					
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Cmanagement/Unit') ?>">Master Unit</a>
                        </h4>
                    </div>
			
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Cmanagement/User') ?>">Master User</a>
                        </h4>
                    </div>
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                <h1>Manajemen Data Departemen, Unit, dan Pengguna</h1>
