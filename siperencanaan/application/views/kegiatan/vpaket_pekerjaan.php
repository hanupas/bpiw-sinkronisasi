				...
				<table class="table table-hover">
					<thead>
						<tr>
							...
							<th rowspan="2">Kode</th>
                                                        <th style="width:80px; text-align:center" rowspan="2">Program</th>
                                                        <th style="width:80px; text-align:center" rowspan="2">Kegiatan</th>
                                                        <th style="width:80px; text-align:center" rowspan="2">Output</th>
							<th style="width:80px; text-align:center" rowspan="2">Paket/Sub Paket</th>
                                                        <th style="width:80px; text-align:center" colspan="3">Dana</th>
                                                        <th style="width:80px; text-align:center" rowspan="2">Jenis Kontrak</th>
                                                        <th style="width:80px; text-align:center" rowspan="2"></th>
						</tr>
                                                <tr>
                                                    <th>RPM</th>
                                                    <th>PHA</th>
					...
					<tbody>
                                            <?php foreach ($paket_pekerjaan as $row) { ?>
                                                <tr>
							<td>{{ $index + 1 }}</td>
                                                        <td><?php echo $row->paket_pekerjaan_id ?></td>
                                                        <td><?php echo $row->paket_pekerjaan_nama ?></td>
                                                        <td><?php echo $row->paket_pekerjaan_subpaket ?></td>
                                                        <td><?php echo $row->lokasi_id.'/'.$row->asetID ?></td>
