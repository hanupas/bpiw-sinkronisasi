	...
	<body data-ng-controller="TodoCtrl">
		...
		<div class="container">
			...
			<div style="text-align:left">
				<h1>Entry Usulan Paket Pekerjaan</h1>
				<hr/>
				
			</div>
                            
                            <div class="form-group col-md-12">
                                <label class="col-md-4 control-label" for="textinput">Unit Organisasi</label>
                                <input type="checkbox" name="sda"/>SDA 
                                &nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="sda"/>CK
                                &nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="sda"/>BM
                                &nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="sda"/>PERA
                                &nbsp;&nbsp;&nbsp;
                                <input type="checkbox" name="sda"/>AIL
                            </div>    
                            <div class="form-group col-md-12">
				...
				<h1>Pagu Indikatif</h1>
					...
					<input class="col-md-4" type="text" class="form-control" name="title" ng-model="taskTitle" placeholder="Selisih Usulan Pagu">
                                    <div class="col-md-2"></div>
				...
				<table class="table table-hover">
					<thead>
						<tr>
							...
							<th>Kode</th>
							<th style="width:80px; text-align:center">Nama Paket</th>
							<th style="width:80px; text-align:center">Nama Sub Paket</th>
                                                        <th style="width:80px; text-align:center">Lokasi/Aset</th>
                                                        <th style="width:80px; text-align:center">Nilai(Rupiah)</th>
                                                        <th style="width:80px; text-align:center">Edit Row</th>
                                                        <th style="width:80px; text-align:center">NA</th>
                                                        <th style="width:80px; text-align:center">Biaya</th>
                                                        <th style="width:80px; text-align:center">Wewenang</th>
                                                        <th style="width:80px; text-align:center">Konstribusi</th>
                                                        <th style="width:80px; text-align:center">SDM Diminta</th>
                                                        <th style="width:80px; text-align:center">Assesment Keterpaduan</th>
                                                        <th style="width:80px; text-align:center">Assesment Sinkronisasi</th>
