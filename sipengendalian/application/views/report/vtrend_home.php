...
-->	  
	...
	<div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Report/Bar') ?>">Fisik vs Serapan Dana</a>
                        </h4>
                    </div>
					
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Report/Bar') ?>">Fisik</a>
                        </h4>
                    </div>
					
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="<?php echo base_url('index.php/Report/Bar') ?>">Serapan Dana</a>
                        </h4>
                    </div>
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                  <p><img width="100%" src="<?php echo base_url('asset/images/trend.jpg');?>" /></p>
            </div>
        </div>
    </div>
