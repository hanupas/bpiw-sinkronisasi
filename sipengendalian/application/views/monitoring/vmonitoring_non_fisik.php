...
-->	  
	...
	<div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Proses Monitoring</a>
                        </h4>
                    </div>
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                <tr><td><a href="#">Kick Off</a></td></tr>
                                <tr><td><a href="#">Pendahuluan</a></td></tr>
                                <tr><td><a href="#">Antara</a></td></tr>
                                <tr><td><a href="#">Hasil Akhir</a></td></tr>
                                <tr><td><a href="#">Evaluasi Akhir</a></td></tr>
                            </table>
                        </div>
                    </div>
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                <h1>Monitoring Kegiatan Non Fisik</h1>
                Sistem Informasi Pengendalian Tersinkronisasi Pembangunan Infrastruktur PUPR(SIP)
            </div>
        </div>
    </div>
